...
<tbody>
  <tr>
    ...
    <td><strong><code>{{% keypop-genericcard-jvm-api-version %}}</code></strong></td>
  </tr>
  <tr>
    <td>{{< icon name="exchange-alt" pack="fas" >}} <a href="https://github.com/eclipse-keypop/keypop-genericcard-jvm-api/blob/main/CHANGELOG.md">Changelog</a></td>
    <td>List of changes and new features introduced in each release.</td>
  </tr>
  <tr>
    <td>{{< icon name="github" pack="fab" >}} <a href="https://github.com/eclipse-keypop/keypop-genericcard-jvm-api/">GitHub</a></td>
  ...
  <tr>
    <td>{{< icon name="file-code" pack="fas" >}} <a href="https://docs.keypop.org/keypop-genericcard-jvm-api/">API Reference</a></td>
  ...
  <tr>
    <td>{{< icon name="database" pack="fas" >}} <a href="https://central.sonatype.com/search?q=keypop-genericcard-jvm-api">Maven Central</a></td>
